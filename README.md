...
1. Arquitectura
2. Por qué esto es "microservicios" de verdad
3. El agente como capa de orquestación
4. Modo demo (sin llave de API)
5. Cómo correrlo
6. Probarlo
7. Cómo escalar cada servicio
...
- **Por qué HTTP simple y no gRPC/mensajería asíncrona**: para un
  ...
  mensajes (Kafka/RabbitMQ, para desacoplar productor/consumidor) serían
  el siguiente paso natural — especialmente si algunas operaciones no
  necesitan respuesta síncrona inmediata.
